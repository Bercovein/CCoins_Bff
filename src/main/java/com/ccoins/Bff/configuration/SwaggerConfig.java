...
import com.ccoins.Bff.controller.OauthController;
...
public class SwaggerConfig {
    ...
    public Docket swaggerDocket() {
        ...
        return new Docket(SWAGGER_2)
                ...
                .select()
                .apis(basePackage(OauthController.class.getPackage().getName()))     // package base donde va a encontrar los controladores
